...
| [`gen_ai.agent.turn.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [11] | int | The number of agent turns completed during the agent invocation. [12] | `1`; `3` |
...
**[11] `gen_ai.agent.turn.count`:** If the agent loop is observable to the instrumentation.

**[12] `gen_ai.agent.turn.count`:** A turn is one cycle of the agent loop: a model inference together with the tool executions it requested. Instrumentations SHOULD record the total on the `invoke_agent` span when the invocation ends, so a single-turn invocation reports `1`.
...
| [`gen_ai.request.choice.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If available, in the request, and !=1. | int | The target number of candidate completions to return. | `3` |
| [`gen_ai.request.seed`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If applicable and if the request includes a seed. | int | Requests with same seed value more likely to return same result. | `100` |
| [`gen_ai.agent.turn.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [8] | int | The number of agent turns completed during the agent invocation. [9] | `1`; `3` |
| [`gen_ai.request.frequency_penalty`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | double | The frequency penalty setting for the GenAI request. | `0.1` |
| [`gen_ai.request.max_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The maximum number of tokens the model generates for a request. | `100` |
...
**[8] `gen_ai.agent.turn.count`:** If the agent loop is observable to the instrumentation.

**[9] `gen_ai.agent.turn.count`:** A turn is one cycle of the agent loop: a model inference together with the tool executions it requested. Instrumentations SHOULD record the total on the `invoke_agent` span when the invocation ends, so a single-turn invocation reports `1`.
